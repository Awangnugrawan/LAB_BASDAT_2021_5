...
class MyQuery{
    ...
    function update_name() {
        ...
        // TODO [2] : menonaktikan commit
        $this->conn->query('SET AUTOCOMMIT = OFF');

        // TODO [3] : memulai transaction
        $this->conn->query('BEGIN');

        // TODO [4] : masukkan query untuk mengupdate nama berdasarkan id
        //
        $sql = "UPDATE customers SET customerName = '$new_nama' WHERE customerNumber = '$list_id[$input]'";
        ...
        switch ($choice) {
            case 1:
                // TODO [5] : melakukan commit
                $this->conn->query('COMMIT');
                return;
            case 2:
                // TODO [6] : melakukan rollback
